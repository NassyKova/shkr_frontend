...
function Product(props) {
    ...
    return (
        ...
        <Wrapper style={{cursor:'pointer'}} onClick={() => {
            ...
            <Ingridients key={"ingrindient-item-" + item.id}>{item.strIngredient1}{", "}{item.strIngredient2}{", "}{item.strIngredient3}{", "}{item.strIngredient4}{", "}{item.strIngredient5}</Ingridients>
